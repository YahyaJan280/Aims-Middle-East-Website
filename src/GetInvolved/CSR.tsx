...
${fileName ? `Document Attached: ${fileName}` : "No document attached"}
  ...
  return (
    <>
      <Navigation />
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white font-roboto to-indigo-50">
        <div className="max-w-5xl mx-auto px-4 py-24 md:py-28 lg:py-28 sm:px-6 lg:px-8">
          {/* Hero Section */}
          ...
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="bg-primary/95 px-6 md:px-8 py-6">
              <h2 className="text-xl md:text-3xl font-bold text-center justify-center text-white flex items-center gap-3">
                        ...
                        <input
                          ...
                          className={`w-full pl-11 pr-4 py-3 border-2 rounded-lg focus:outline-none transition-colors ${
                            !validateField("orgName")
                              ? "border-red-300 focus:border-primary/95"
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-11 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-primary/95 transition-colors"
                          />
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <select
                            ...
                            onChange={handleInputChange}
                            className="w-full pl-11 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-primary/95 transition-colors bg-white appearance-none"
                          >
                          ...
                          <input
                            ...
                            className={`w-full pl-11 pr-4 py-3 border-2 rounded-lg focus:outline-none transition-colors ${
                              !validateField("contactName")
                                ? "border-red-300 focus:border-primary/95"
                                : "border-gray-300 focus:primary/95"
                            }`}
                          />
                          {!validateField("contactName") && (
                            <p className="mt-1 text-sm text-red-600 flex items-center gap-1">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-blue-400 transition-colors bg-gray-50">
                    ...
                    <label htmlFor="fileUpload" className="cursor-pointer">
                      ...
                      <p className="text-sm text-gray-500 mt-2">
                        CSR proposal, brochure, or document (PDF, DOC, DOCX -
                        Max 10MB)
                      </p>
                    </label>
                    <input
