...
- Professional Certification (if applicable): ${formData.uploadProfCertApplicable ? 'Yes' : 'No'}
      `;
      ...
      setSubmitMessage('There was an error submitting your application. Please try again or contact us directly at asdkhn@gmail.com');
    } finally {
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Join our community of passionate individuals dedicated to making a positive impact across Pakistan and the Middle East.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 px-6 md:px-8 py-6">
            ...
            <p className="text-blue-100 mt-2">Please fill in all required information</p>
          </div>
            ...
            <div className="space-y-8">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-6 pb-2 border-b-2 border-blue-200 flex items-center gap-2">
                  ...
                  Document Upload <span className="text-sm font-normal text-gray-500">(Optional)</span>
                </h3>
                  ...
                  <div className="space-y-3">
                    <label className="flex items-start p-4 bg-white rounded-lg border-2 border-gray-200 hover:border-blue-300 cursor-pointer transition-colors">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-sm text-gray-500 mt-1">Upload a copy of your national identification card</p>
                      </div>
                    </label>
                    ...
                    <label className="flex items-start p-4 bg-white rounded-lg border-2 border-gray-200 hover:border-blue-300 cursor-pointer transition-colors">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-sm text-gray-500 mt-1">Upload relevant professional certificates or licenses</p>
                      </div>
                    </label>
                    ...
                    <label className="flex items-start p-4 bg-white rounded-lg border-2 border-gray-200 hover:border-blue-300 cursor-pointer transition-colors">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-sm text-gray-500 mt-1">Any other relevant professional documentation (if applicable)</p>
                      </div>
                    </label>
                  </div>
                </div>
              ...
              <div className="pt-4">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 disabled:from-gray-400 disabled:to-gray-500 text-white text-lg font-semibold py-4 px-6 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600">
            ...
            <a href="mailto:asdkhn@gmail.com" className="text-blue-600 hover:text-blue-800 font-semibold">
              asdkhn@gmail.com
            </a>
          </p>
        </div>
