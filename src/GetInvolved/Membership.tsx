              ...
              <div className="max-w-[1200px] mx-auto">
                ...
                <div className="bg-gray-50 rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                  ...
                  <div className="bg-primary px-4 sm:px-6 md:px-8 py-5 sm:py-6 text-center text-white">
                    ...
                    <p className="font-roboto text-sm sm:text-base text-blue-100 mt-2">
                      Please fill in all required information
                    </p>
                  </div>

                  {/* Body */}
                  <div className="bg-white p-5 sm:p-6 md:p-8 lg:p-10 space-y-6 sm:space-y-8">
                    {/* Personal Information */}
                    <div>
                      <h3 className="font-roboto text-lg sm:text-xl font-bold text-primary/95 mb-4 sm:mb-6 pb-2 border-b-2 border-blue-200 flex items-center gap-2">
                        Personal Information
                      </h3>
                      ...
                      <div className="space-y-5 sm:space-y-6">
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className={`w-full pl-10 sm:pl-12 pr-4 py-2.5 sm:py-3 border-2 rounded-lg focus:outline-none transition-colors font-roboto text-sm sm:text-base ${
                        ...
                        {/* Email and Phone */}
                        <div className="grid grid-cols-1 t md:grid-cols-2 gap-5 sm:gap-6 text-left">
                          {[
                            {
                              name: "email",
                              label: "Email Address",
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 rounded-xl p-4 sm:p-6 space-y-4 font-roboto">
                        ...
                        {[
                          ...
                          <label
                            key={item.name}
                            className="flex text-left items-start p-3 sm:p-4 bg-white rounded-lg border-2 border-gray-200 hover:border-primary/70 cursor-pointer transition-colors"
                          >
                            <input
                              type="checkbox"
                              name={item.name}
                    ...
                    {submitMessage && (
                      <div
                        className={`flex items-start gap-3 p-3 sm:p-4 rounded-lg font-roboto ${
                ...
                {/* Additional Info */}
                <div className="mt-6 sm:mt-8 text-center font-roboto">
