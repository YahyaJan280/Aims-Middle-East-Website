        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="bg-primary/95 px-6 md:px-8 py-6">
              <h1 className="text-2xl md:text-3xl text-center justify-center font-bold text-white flex items-center gap-3">
                Membership Application Form
              </h1>
              <p className="text-blue-100 text-center mt-2 font-roboto">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-11 pr-4 py-3 border-2 rounded-lg focus:outline-none transition-colors font-roboto ${
          ...
          <div className="mt-8 text-center font-roboto">
            <p className="text-gray-600">
              ...
              <a href="mailto:asdkhn@gmail.com" className="text-primary/95 hover:text-primary font-semibold">
                asdkhn@gmail.com
              </a>
            </p>
          </div>
