          ...
          <section className="relative py-12 w-full   sm:py-16 lg:py-20 xl:py-24 bg-cover bg-center overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 mt-">
              <div className="max-w-[1200px] mx-auto text-center">
                <h2 className="font-roboto text-xl sm:text-2xl lg:text-4xl md:text-4xl xl:text-5xl 2xl:text-5xl text-white font-bold mb-3 sm:mb-4 lg:mb-6">
                ...
                <p className="font-roboto text-sm sm:text-base lg:text-lg xl:text-xl 2xl:text-xl text-gray-100 max-w-3xl mx-auto leading-relaxed mb-4 sm:mb-6 lg:mb-8 px-4">
                  Join us in our mission to provide world-class diabetes care
                ...
                >
                  <button className="font-roboto bg-white hover:bg-red-500 hover:text-white text-primary/95 font-semibold px-6 sm:px-8 lg:px-10 py-3 sm:py-4 rounded-lg transition-all duration-300 text-sm sm:text-base lg:text-lg shadow-lg hover:shadow-xl transform hover:scale-105">
                    Learn More
                  </button>
                </a>
              </div>
