              ...
              <div className="max-w-[1200px] mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
                  ...
                  <div className="order-1 md:order-2">
                    <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-primary mb-4 md:mb-6 text-left">
          ...
          <section className="py-12 md:py-16 lg:py-20 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
              <div className="max-w-6xl mx-auto">
                <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white text-center mb-8 md:mb-12 lg:mb-16">
                  Impact in Numbers
                </h2>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 lg:gap-12 text-center">
                  <div>
                    <div className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-2 md:mb-4">
                      2,500+
                    </div>
