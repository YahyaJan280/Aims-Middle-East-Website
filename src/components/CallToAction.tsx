...
import MakeADiffImage from "@/assets/Cntre-element.png";
  ...
  return (
    <div key={index} className="animate-on-scroll opacity-0 group">
      <div className="bg-white/10 backdrop-blur-md p-6 sm:p-7 md:p-8 lg:p-10 rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-500 hover:scale-105 hover:shadow-2xl h-full flex flex-col justify-between">
        ...
        <div className="animate-on-scroll opacity-0 mt-16">
          <div className="bg-white/10 backdrop-blur-md p-6 sm:p-8 md:p-10 lg:p-12 rounded-2xl border border-white/20 text-center max-w-4xl mx-auto">
            ...
            <p className="text-sm sm:text-base text-center text-muted-foreground text-white mb-6 leading-relaxed">
              ...
              <br /> across the Middle East. Every action, no matter how small,
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
              <Link
                to="/contact"
                className="bg-white text-primary hover:bg-white/90 px-6 sm:px-8 py-3 sm:py-3.5 rounded-lg font-medium border border-white group flex items-center justify-center gap-2 text-sm sm:text-base transition-all duration-300"
              >
                Contact Us Today
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </Link>
        ...
        {/* Make a Difference Card BELOW Contact Section */}
        <div className="mt-12 flex flex-col items-center animate-on-scroll opacity-0">
          <img
            src={MakeADiffImage}
            alt="Make a Difference"
            className="w-[200px] max-w-md rounded-xl mb-6"
          />
        </div>
      </div>
    </section>
