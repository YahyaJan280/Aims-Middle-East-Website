  ...
  return (
    <section
      ...
      className="
        ...
        bg-gradient-to-b from-gray-50 to-white py-12 sm:py-16 md:py-20
      "
    >
      <div className="max-w-[1265px] mx-auto px-4 sm:px-6 lg:px-8">
        {/* Heading */}
        <div className="text-center mb-12 sm:mb-14 md:mb-16">
          <h2 className="font-roboto text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 animate-on-scroll opacity-0 px-4 text-primary/95">
            Our Objectives
          </h2>
          <p className="font-roboto font-normal text-base sm:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto animate-on-scroll opacity-0 px-4 text-muted-foreground leading-relaxed">
          ...
          {objectives.map((objective, index) => (
            <div key={index} className="animate-on-scroll opacity-0 group">
              <div className="relative bg-white p-6 sm:p-7 md:p-8 rounded-2xl shadow-lg hover:shadow-2xl border border-gray-100 transition-all duration-500 h-full flex flex-col overflow-hidden">
                ...
                <div className="mb-6">
                  <div
                    className={`inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 ${objective.iconBg} rounded-xl transition-all duration-500 group-hover:scale-110 group-hover:rotate-3`}
                  >
                    <objective.icon
                      className={`w-7 h-7 sm:w-8 sm:h-8 ${objective.iconColor}`}
                      strokeWidth={2}
                    />
                  </div>
                </div>
                ...
                {/* Title */}
                <h3 className="font-roboto text-xl sm:text-2xl font-bold text-primary mb-3 group-hover:text-primary transition-colors duration-300">
                  {objective.title}
                </h3>

                {/* Description */}
                <p className="font-roboto text-sm sm:text-base  text-muted-foreground text-gray-600 mb-6 leading-relaxed">
                  ...
                  {objective.features.map((feature, featureIndex) => (
                    ...
                    >
                      <CheckCircle2
                        ...
                        strokeWidth={2}
                      />
                      <span className="font-roboto text-sm text-gray-700 text-muted-foreground  leading-snug">
                        {feature}
                      </span>
                    </div>
                  ))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-7 md:gap-8">
            ...
            <div className="animate-on-scroll opacity-0">
              <div className="relative p-6 sm:p-8 bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 transition-all duration-300 group overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-full -mr-16 -mt-16 opacity-50 group-hover:scale-150 transition-transform duration-500"></div>
                <div className="relative z-10">
                  <div className="inline-flex items-center justify-center w-16 h-16 sm:w-14 sm:h-14  rounded-lg mb-4">
                    <Users
                      className="w-6 h-6 sm:w-7 sm:h-7 text-primary"
                      strokeWidth={2}
                    />
