  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* CTA */}
        <div className="mt-12 sm:mt-16 text-center animate-on-scroll lg:max-w-[1210px] lg:ml-[60px] opacity-0 relative bg-primary/95 rounded-2xl overflow-hidden">
          ...
          <div className="relative z-10 p-6 sm:p-8 lg:p-12 lg:py-10">
            ...
            <Link to="/partners/become">
              <Button className="font-roboto font-medium animate-pulse-glow bg-white text-primary hover:text-white">
                Partner With Us
              </Button>
            </Link>
          </div>
