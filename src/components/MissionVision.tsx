    ...
    >
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-10 sm:mb-12 md:mb-16">
          ...
          <p className="text-sm sm:text-base md:text-lg text-slate-600 max-w-3xl mx-auto animate-on-scroll opacity-0 translate-y-8 transition-all duration-700 leading-relaxed font-light">
          ...
          <div className="animate-on-scroll opacity-0 translate-y-8 transition-all duration-700">
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-200 h-full">
              <div className="p-5 sm:p-6 md:p-7">
                ...
                {/* Description */}
                <p className="text-sm sm:text-base text-slate-600 text-left leading-relaxed mb-4">
                  To be the{" "}
