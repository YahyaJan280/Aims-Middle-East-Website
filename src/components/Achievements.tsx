...
const Achievements = () => {
  ...
  return (
    <section
      id="achievements"
      ref={sectionRef}
      className="py-12 sm:py-16 lg:py-20 relative w-screen -ml-[50vw]  mt-12 -mr-[50vw] left-1/2 right-1/2  overflow-hidden bg-muted/30"
    >
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
          ...
          <div className="animate-on-scroll opacity-0 flex flex-col bg-card/20 rounded-2xl p-5 sm:p-6 lg:p-8 border border-primary/10">
            <h3 className="font-roboto text-xl sm:text-2xl lg:text-3xl font-bold gradient-text mb-3 sm:mb-4">
              Transforming Lives, One Patient at a Time
            </h3>
            <p className="font-roboto font-medium text-sm sm:text-base text-muted-foreground mb-5 sm:mb-6 leading-relaxed">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-start gap-3 p-3 sm:p-4 bg-card rounded-lg border-l-4 border-primary">
                <Heart className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-roboto font-semibold text-sm sm:text-base text-foreground">
              ...
              <div className="flex items-start gap-3 p-3 sm:p-4 bg-card rounded-lg border-l-4 border-secondary">
          ...
          <div className="animate-on-scroll opacity-0 bg-gradient-primary/5 p-5 sm:p-6 lg:p-8 rounded-2xl border border-primary/10">
            <h4 className="font-roboto text-xl sm:text-2xl font-bold gradient-text mb-4 sm:mb-6 text-center">
