          ...
          <section className="py-12 sm:py-16 lg:py-20 xl:py-24">
            <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
              <div className="max-w-[1200px] mx-auto">
                <h2 className="font-roboto text-3xl sm:text-4xl lg:text-5xl xl:text-5xl 2xl:text-5xl font-bold text-primary/95 text-center mb-3 sm:mb-4">
          ...
          <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="relative w-screen left-[50%] right-[50%] -ml-[50vw] -mr-[50vw] bg-primary rounded-2xl shadow-2xl p-8 sm:p-10 lg:p-12 xl:p-14 overflow-hidden">
                ...
                <h3 className="font-roboto text-2xl sm:text-4xl lg:text-5xl xl:text-5xl font-bold text-white mb-3 sm:mb-4">
