                  ...
                  >
                    ...
                    <div className="flex flex-col md:flex-row">
                      ...
                      <div className="md:w-2/3 p-6 sm:p-8 flex flex-col justify-center">
                        <h3 className="font-roboto text-xl sm:text-2xl lg:text-3xl font-bold text-primary mb-3 sm:mb-4  transition-colors duration-300">
                          {cert.title}
                        </h3>
                        <p className="font-roboto text-sm sm:text-base lg:text-lg text-gray-600 text-muted-foreground leading-relaxed">
                          {cert.description}
                        </p>
                      </div>
                    </div>
