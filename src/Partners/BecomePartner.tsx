                  ...
                  {partnershipPoints.map((point, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <h3 className="relative font-roboto text-2xl sm:text-3xl lg:text-3xl xl:text-3xl font-bold text-primary mb-3 sm:mb-4">
                          {point.title}
                        </h3>
                        <p className="relative font-roboto text-sm sm:text-base lg:text-base xl:text-lg text-gray-700 leading-relaxed text-muted-foreground">
                          {point.description}
                        </p>
                      </div>
                    );
