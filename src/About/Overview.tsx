          ...
          <section className="relative text-white py-12 md:py-16 lg:py-20  overflow-hidden">
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
              <div className="max-w-4xl mx-auto text-center">
                <h1 className="font-roboto font-bold text-3xl sm:text-4xl md:text-4xl lg:text-6xl mb-4 md:mb-6 leading-tight">
                  About AIMS Middle East
                </h1>
                <p className="font-roboto text-base sm:text-lg md:text-2xl max-w-3xl mx-auto leading-relaxed font-medium">
              ...
              <div className="max-w-[1200px] mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center mb-12 md:mb-16 lg:mb-20">
                  ...
                  <div className="order-1 md:order-2">
                    <h2 className="text-2xl md:text-3xl lg:text-4xl  md:text-left text-left font-bold text-primary mb-3 md:mb-4 lg:mb-6">
                      Who We Are
                    </h2>
                    ...
                    <h2 className="text-2xl md:text-3xl lg:text-4xl text-left md:text-left font-bold text-primary mb-3 md:mb-4">
                      Our Purpose
                    </h2>
